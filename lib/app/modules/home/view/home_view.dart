                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text('online',style: Styles.black18,)
                    ],
                  ),
                      ...
                      children: List.generate(
                          ...
                          (index) => Column(
                            children: [
                              ...
                              Text('Angela,20',style: Styles.black12,)
                            ],
                          )),
                    ),
                  ),
                  ...
                  Row(
                    children: [
                      const SizedBox(width: 16,),
                      Text('Recents',style: Styles.grey16.copyWith(fontWeight: FontWeight.w700,fontSize: 20),),
                    ],
                  ),
                  const SizedBox(height: 20,),
                  _recent(),
                  ...
                  Row(
                    children: [
                      const SizedBox(width: 16,),
                      Text('Suggestions',style: Styles.grey16.copyWith(fontWeight: FontWeight.w700,fontSize: 20),),
                    ],
                  ),
                ],
              ),
