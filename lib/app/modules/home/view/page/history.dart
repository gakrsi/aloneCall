                    ...
                    return InkWell(
                      onTap: () async {
                        model.callerUid == Repository().uid
                            ? await Repository().getUserDataByUid(model.receiverUid).then((value){
                              Utility.printDLog('${value.uid}');
                              RoutesManagement.goToOthersProfileDetail(obj: value);})
                            : await Repository().getUserDataByUid(model.callerUid).then((value){
